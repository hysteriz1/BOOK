...
// QueryUSERSTATUSUSER chains the current query on the USERSTATUS_USER edge.
...
// the "USERSTATUS_USER" edge. The optional arguments used to configure the query builder of the edge.
...
//		GroupBy(userstatus.FieldSTATUS).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
