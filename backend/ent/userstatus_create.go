...
func (usc *UserStatusCreate) SetSTATUS(s string) *UserStatusCreate {
	usc.mutation.SetSTATUS(s)
	return usc
}

// AddUSERSTATUSUSERIDs adds the USERSTATUS_USER edge to User by ids.
func (usc *UserStatusCreate) AddUSERSTATUSUSERIDs(ids ...int) *UserStatusCreate {
	usc.mutation.AddUSERSTATUSUSERIDs(ids...)
	return usc
}

// AddUSERSTATUSUSER adds the USERSTATUS_USER edges to User.
func (usc *UserStatusCreate) AddUSERSTATUSUSER(u ...*User) *UserStatusCreate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return usc.AddUSERSTATUSUSERIDs(ids...)
}
...
func (usc *UserStatusCreate) createSpec() (*UserStatus, *sqlgraph.CreateSpec) {
	...
	if nodes := usc.mutation.USERSTATUSUSERIDs(); len(nodes) > 0 {
