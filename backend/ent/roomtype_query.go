...
// QueryROOMTYPEROOM chains the current query on the ROOMTYPE_ROOM edge.
...
// the "ROOMTYPE_ROOM" edge. The optional arguments used to configure the query builder of the edge.
...
//		GroupBy(roomtype.FieldROOMTYPEDATA).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
//
//	client.RoomType.Query().
//		Select(roomtype.FieldROOMTYPEDATA).
//		Scan(ctx, &v)
//
