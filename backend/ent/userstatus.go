...
// USERSTATUSUSEROrErr returns the USERSTATUSUSER value or an error if the edge
// was not loaded in eager-loading.
func (e UserStatusEdges) USERSTATUSUSEROrErr() ([]*User, error) {
	if e.loadedTypes[0] {
		return e.USERSTATUSUSER, nil
	}
	return nil, &NotLoadedError{edge: "USERSTATUS_USER"}
}
...
func (us *UserStatus) assignValues(values ...interface{}) error {
	...
	if value, ok := values[0].(*sql.NullString); !ok {
		...
		us.STATUS = value.String
	}
	return nil
}

// QueryUSERSTATUSUSER queries the USERSTATUS_USER edge of the UserStatus.
func (us *UserStatus) QueryUSERSTATUSUSER() *UserQuery {
	return (&UserStatusClient{config: us.config}).QueryUSERSTATUSUSER(us)
}
